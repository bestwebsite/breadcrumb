...
function bestwebsite_breadcrumb( $args = array() ) {

	$breadcrumb = apply_filters( 'bestwebsite_breadcrumb_object', null, $args );

	if ( ! is_object( $breadcrumb ) )
		$breadcrumb = new bestwebsite_breadcrumb( $args );
...
class bestwebsite_breadcrumb {
	...
	/**
	 * Sets up the breadcrumb trail properties.  Calls the `bestwebsite_breadcrumb::add_items()` method
	 ...
	 *     @type array     $labels         Text labels. @see bestwebsite_breadcrumb::set_labels()
	 *     @type array     $post_taxonomy  Taxonomies to use for post types. @see bestwebsite_breadcrumb::set_post_taxonomy()
	...
	public function __construct( $args = array() ) {
		...
		$this->args = apply_filters( 'bestwebsite_breadcrumb_args', wp_parse_args( $args, $defaults ) );
	...
	public function trail() {
		...
		$breadcrumb = apply_filters( 'bestwebsite_breadcrumb', $breadcrumb, $this->args );
	...
	protected function set_labels() {
		...
		$this->labels = apply_filters( 'bestwebsite_breadcrumb_labels', wp_parse_args( $this->args['labels'], $defaults ) );
	}
	...
	protected function set_post_taxonomy() {
		...
		$this->post_taxonomy = apply_filters( 'bestwebsite_breadcrumb_post_taxonomy', wp_parse_args( $this->args['post_taxonomy'], $defaults ) );
	}
	...
	protected function add_items() {
		...
		$this->items = array_unique( apply_filters( 'bestwebsite_breadcrumb_items', $this->items, $this->args ) );
	}
